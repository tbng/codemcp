...
from codemcp.tools.lint import lint_code, _get_lint_command, _check_for_changes
...
class TestLint(TestCase):
    ...
    def setup_mocks(self):
        ...
        self.is_git_repo_patch = patch("codemcp.tools.lint.is_git_repository")
        ...
        self.commit_changes_patch = patch("codemcp.tools.lint.commit_changes")
        ...
        # Patch run_command
        self.run_command_patch = patch("codemcp.tools.lint.run_command")
        ...
        self.normalize_path_patch = patch("codemcp.tools.lint.normalize_file_path")
