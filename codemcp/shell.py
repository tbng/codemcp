...
def run_command(
    ...
    if text:
        ...
        stdout_len = len(result.stdout) if hasattr(result, 'stdout') and result.stdout else 0
        stderr_len = len(result.stderr) if hasattr(result, 'stderr') and result.stderr else 0
